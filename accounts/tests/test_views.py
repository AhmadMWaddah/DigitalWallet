...
class TestLoginView:
    ...
    def test_login_valid_credentials_client(self, client):
        ...
        response = client.post(
            ...
            {"email": "clientlogin@example.com", "password": "testpass123"},
        )
    ...
    def test_login_valid_credentials_staff(self, client):
        ...
        response = client.post(
            reverse("accounts:login"),
            {"email": "stafflogin@example.com", "password": "testpass123"},
        )
    ...
    def test_login_empty_email(self, client):
        ...
        response = client.post(reverse("accounts:login"), {"email": "", "password": "testpass123"})
    ...
    def test_login_empty_password(self, client):
        ...
        CustomUser.objects.create_user(email="emptypass@example.com", password="testpass123")

        response = client.post(
            reverse("accounts:login"), {"email": "emptypass@example.com", "password": ""}
        )
...
class TestStaffOnlyMixin:
    ...
    def test_staff_user_can_access(self, client):
        ...
        staff_user = CustomUser.objects.create_user(
            email="staffmixin@example.com", password="testpass123", user_type=UserType.STAFF
        )
    ...
    def test_client_user_denied_access(self, client):
        ...
        client_user = CustomUser.objects.create_user(
            email="clientmixin@example.com", password="testpass123", user_type=UserType.CLIENT
        )
...
class TestClientOnlyMixin:
    ...
    def test_client_user_can_access(self, client):
        ...
        client_user = CustomUser.objects.create_user(
            email="clientonly@example.com", password="testpass123", user_type=UserType.CLIENT
        )
    ...
    def test_staff_user_denied_access(self, client):
        ...
        staff_user = CustomUser.objects.create_user(
            email="staffclient@example.com", password="testpass123", user_type=UserType.STAFF
        )
...
class TestAuthenticationFlow:
    ...
    def test_full_login_logout_cycle(self, client):
        ...
        login_response = client.post(
            reverse("accounts:login"), {"email": "cycle@example.com", "password": "testpass123"}
        )
    ...
    def test_staff_portal_separation(self, client):
        ...
        staff_login = client.post(
            reverse("accounts:login"),
            {"email": "portalseparation@example.com", "password": "testpass123"},
        )
        ...
        client_login = client.post(
            reverse("accounts:login"),
            {"email": "portalclient@example.com", "password": "testpass123"},
        )
